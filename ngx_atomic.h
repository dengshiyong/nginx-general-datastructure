...
//ngx_atomic_cmp_set　exists in the file ngx_gcc_atomic_amd64.h ngx_gcc_atomic....h　and so on
...
// the asm volatile means it's a asm code
// NGX_SMP_LOCK in x86 amd64 machine means "lock;"
// the "lock;" stand for the dB level of bus will be set to 0,and the cpu can not visit the memory through the bus
